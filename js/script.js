...
currentSwiper = new Swiper('.comic-swiper', {
    ...
    // Включаем поддержку жестов и предотвращаем конфликты
    touchMoveStopPropagation: true, 
    nested: true, // Помогает, если есть вложенные элементы
...
zoom: {
    ...
    on: {
        ...
        zoomChange: function (swiper, scale, imageEl, slideEl) {
            if (scale > 1) {
                // Если зум активен — блокируем скролл всей страницы
                document.body.style.touchAction = 'none';
                document.documentElement.style.overflow = 'hidden';
            } else {
                // Если вернулись к 1:1 — возвращаем стандартное поведение
                document.body.style.touchAction = 'pan-y';
                document.documentElement.style.overflow = '';
            }
        },
        
        // Страховка: сбрасываем блокировку при перелистывании
