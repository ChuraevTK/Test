...
function loadComic() {
    ...
    for (let i = 0; i < totalPages; i++) {
        ...
        // Добавляем контейнер для зума (нужен для Swiper Zoom)
    ...
    currentSwiper = new Swiper('.comic-swiper', {
        ...
        slidesPerView: 1,
        spaceBetween: 0,
        // Настройки зума как в Instagram
        zoom: {
            maxRatio: 3,
            minRatio: 1,
            toggle: true // Зум по двойному тапу
        },
        navigation: {
        ...
        autoHeight: true,
        allowTouchMove: true,
        passiveListeners: true, // Помогает со скроллом
        touchMoveStopPropagation: false // Разрешает всплытие событий для скролла страницы
    });
